...
if __name__=="__main__":
    issuer_private_key_file = 'PrivateKey.pem' #sys.argv[1]
    certificate_subject = 'Code5Test' #sys.argv[2]
    certificate_subject_public_key_file = 'PublicKey.pem'#sys.argv[3]
    certificate_output_file = 'fakecert.cer' #sys.argv[4]
